...
library(tidyverse) #Borrarlo para la act
...
#blue<- "344D7E"   # Despues borrarlo para la act!
#fuente<-"Fuente: Elaboración propia"  # Despues borrarlo para la act!
...
n1<-  original # Despues borrarlo para la act!
...
n1<- n1 %>% 
  ...
  rename("Centro.Costo" = "CC") # despues borralo para la act!!


#  Cambiale el nombre e la columna "CC", por "Centro.Costo":
...
# Escribi la funciòn para visualizar la tabla
...
# Escribi la funciòn para saber la edad promedio de los activos 
...
# Escribi la funcion y la base de datos a consultar:  
...
# Se ven todas las variables? ¿Que pudo haber pasado?
